...
const DeviceKind$json = {
  ...
  '2': [
    ...
    {'1': 'DEVICE_KIND_DIGITAL_INPUT', '2': 7},
  ],
};
...
final $typed_data.Uint8List deviceKindDescriptor = $convert
    .base64Decode('CgpEZXZpY2VLaW5kEhsKF0RFVklDRV9LSU5EX1VOU1BFQ0lGSUVEEAASGwoXREVWSUNFX0tJTk'
        ...
        'Eh0KGURFVklDRV9LSU5EX0RJR0lUQUxfSU5QVVQQBw==');
...
@$core.Deprecated('Use caretSideDescriptor instead')
const CaretSide$json = {
  '1': 'CaretSide',
  '2': [
    {'1': 'CARET_SIDE_UNSPECIFIED', '2': 0},
    {'1': 'CARET_SIDE_BEFORE', '2': 1},
    {'1': 'CARET_SIDE_AFTER', '2': 2},
  ],
};

/// Descriptor for `CaretSide`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List caretSideDescriptor = $convert
    .base64Decode('CglDYXJldFNpZGUSGgoWQ0FSRVRfU0lERV9VTlNQRUNJRklFRBAAEhUKEUNBUkVUX1NJREVfQk'
        'VGT1JFEAESFAoQQ0FSRVRfU0lERV9BRlRFUhAC');

@$core.Deprecated('Use caretMotionDescriptor instead')
const CaretMotion$json = {
  '1': 'CaretMotion',
  '2': [
    {'1': 'CARET_MOTION_UNSPECIFIED', '2': 0},
    {'1': 'CARET_MOTION_LEFT', '2': 1},
    {'1': 'CARET_MOTION_RIGHT', '2': 2},
    {'1': 'CARET_MOTION_UP', '2': 3},
    {'1': 'CARET_MOTION_DOWN', '2': 4},
    {'1': 'CARET_MOTION_EXIT', '2': 5},
    {'1': 'CARET_MOTION_NEXT_SLOT', '2': 6},
    {'1': 'CARET_MOTION_PREVIOUS_SLOT', '2': 7},
  ],
};

/// Descriptor for `CaretMotion`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List caretMotionDescriptor = $convert
    .base64Decode('CgtDYXJldE1vdGlvbhIcChhDQVJFVF9NT1RJT05fVU5TUEVDSUZJRUQQABIVChFDQVJFVF9NT1'
        'RJT05fTEVGVBABEhYKEkNBUkVUX01PVElPTl9SSUdIVBACEhMKD0NBUkVUX01PVElPTl9VUBAD'
        'EhUKEUNBUkVUX01PVElPTl9ET1dOEAQSFQoRQ0FSRVRfTU9USU9OX0VYSVQQBRIaChZDQVJFVF'
        '9NT1RJT05fTkVYVF9TTE9UEAYSHgoaQ0FSRVRfTU9USU9OX1BSRVZJT1VTX1NMT1QQBw==');
...
@$core.Deprecated('Use provisionStatusDescriptor instead')
const ProvisionStatus$json = {
  '1': 'ProvisionStatus',
  '2': [
    {'1': 'PROVISION_STATUS_UNSPECIFIED', '2': 0},
    {'1': 'PROVISION_STATUS_NO_DEVICE', '2': 1},
    {'1': 'PROVISION_STATUS_NOT_CHOSEN', '2': 2},
    {'1': 'PROVISION_STATUS_UNKNOWN_PROFILE', '2': 3},
    {'1': 'PROVISION_STATUS_INCOMPATIBLE', '2': 4},
    {'1': 'PROVISION_STATUS_TRANSDUCER_INVALID', '2': 5},
    {'1': 'PROVISION_STATUS_KIND_MISMATCH', '2': 6},
    {'1': 'PROVISION_STATUS_VALID', '2': 7},
  ],
};

/// Descriptor for `ProvisionStatus`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List provisionStatusDescriptor = $convert
    .base64Decode('Cg9Qcm92aXNpb25TdGF0dXMSIAocUFJPVklTSU9OX1NUQVRVU19VTlNQRUNJRklFRBAAEh4KGl'
        'BST1ZJU0lPTl9TVEFUVVNfTk9fREVWSUNFEAESHwobUFJPVklTSU9OX1NUQVRVU19OT1RfQ0hP'
        'U0VOEAISJAogUFJPVklTSU9OX1NUQVRVU19VTktOT1dOX1BST0ZJTEUQAxIhCh1QUk9WSVNJT0'
        '5fU1RBVFVTX0lOQ09NUEFUSUJMRRAEEicKI1BST1ZJU0lPTl9TVEFUVVNfVFJBTlNEVUNFUl9J'
        'TlZBTElEEAUSIgoeUFJPVklTSU9OX1NUQVRVU19LSU5EX01JU01BVENIEAYSGgoWUFJPVklTSU'
        '9OX1NUQVRVU19WQUxJRBAH');
...
const MissingKind$json = {
  ...
  '2': [
    ...
    {'1': 'MISSING_KIND_SOURCE_NO_DEVICE', '2': 10},
    {'1': 'MISSING_KIND_PROVIDER_INVALID', '2': 11},
  ],
};
...
final $typed_data.Uint8List missingKindDescriptor = $convert
    .base64Decode('CgtNaXNzaW5nS2luZBIcChhNSVNTSU5HX0tJTkRfVU5TUEVDSUZJRUQQABIqCiZNSVNTSU5HX0'
        ...
        'VFBVVBAIEiQKIE1JU1NJTkdfS0lORF9SRUFMSVpBVElPTl9JTlZBTElEEAkSIQodTUlTU0lOR1'
...
const ClientMessage$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.CreateSourceRequest',
      '9': 0,
      '10': 'createSource'
    },
    {
      '1': 'list_source_candidates',
      '3': 45,
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.ListSourceCandidatesRequest',
      '9': 0,
      '10': 'listSourceCandidates'
    },
    {
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.SourceCompletionRequest',
      '9': 0,
      '10': 'sourceCompletion'
    },
    {
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.SourceDefinitionRequest',
      '9': 0,
      '10': 'sourceDefinition'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.SourceReferencesRequest',
      '9': 0,
      '10': 'sourceReferences'
    },
    {
    ...
    {
      '1': 'list_value_categories',
      '3': 76,
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.ListValueCategoriesRequest',
      '9': 0,
      '10': 'listValueCategories'
    },
    {
      '1': 'navigate_formula',
      '3': 77,
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.NavigateFormulaRequest',
      '9': 0,
      '10': 'navigateFormula'
    },
    {
      '1': 'complete_formula_caret',
      '3': 78,
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.CompleteFormulaCaretRequest',
      '9': 0,
      '10': 'completeFormulaCaret'
    },
    {
      '1': 'get_formula_signature',
      '3': 79,
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.GetFormulaSignatureRequest',
      '9': 0,
      '10': 'getFormulaSignature'
    },
    {
      '1': 'get_formula_render',
      '3': 80,
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.GetFormulaRenderRequest',
      '9': 0,
      '10': 'getFormulaRender'
    },
    {
...
final $typed_data.Uint8List clientMessageDescriptor = $convert
    .base64Decode('Cg1DbGllbnRNZXNzYWdlEh0KCnJlcXVlc3RfaWQYASABKARSCXJlcXVlc3RJZBI4CgloYW5kc2'
        ...
        'dGFudGlhdGVMaWJyYXJ5SXRlbVJlcXVlc3RIAFIWaW5zdGFudGlhdGVMaWJyYXJ5SXRlbRJCCg'
        '1jcmVhdGVfc291cmNlGCwgASgLMhsuYmRsLnYxLkNyZWF0ZVNvdXJjZVJlcXVlc3RIAFIMY3Jl'
        'YXRlU291cmNlElsKFmxpc3Rfc291cmNlX2NhbmRpZGF0ZXMYLSABKAsyIy5iZGwudjEuTGlzdF'
        'NvdXJjZUNhbmRpZGF0ZXNSZXF1ZXN0SABSFGxpc3RTb3VyY2VDYW5kaWRhdGVzElIKE2luaXRf'
        'c3lzdGVtX3Byb2plY3QYMiABKAsyIC5iZGwudjEuSW5pdFN5c3RlbVByb2plY3RSZXF1ZXN0SA'
        'BSEWluaXRTeXN0ZW1Qcm9qZWN0EjkKCmdldF9zeXN0ZW0YMyABKAsyGC5iZGwudjEuR2V0U3lz'
        'dGVtUmVxdWVzdEgAUglnZXRTeXN0ZW0STAoRYXBwbHlfc3lzdGVtX2VkaXQYNCABKAsyHi5iZG'
        'wudjEuQXBwbHlTeXN0ZW1FZGl0UmVxdWVzdEgAUg9hcHBseVN5c3RlbUVkaXQSUgoTcnVuX3N5'
        'c3RlbV9hbmFseXNpcxg1IAEoCzIgLmJkbC52MS5SdW5TeXN0ZW1BbmFseXNpc1JlcXVlc3RIAF'
        'IRcnVuU3lzdGVtQW5hbHlzaXMSSQoQYXBwbHlfZ3JvdXBfZWRpdBg2IAEoCzIdLmJkbC52MS5B'
        'cHBseUdyb3VwRWRpdFJlcXVlc3RIAFIOYXBwbHlHcm91cEVkaXQSbQoccHJldmlld19jb21wb2'
        '5lbnRfZXh0cmFjdGlvbhg3IAEoCzIpLmJkbC52MS5QcmV2aWV3Q29tcG9uZW50RXh0cmFjdGlv'
        'blJlcXVlc3RIAFIacHJldmlld0NvbXBvbmVudEV4dHJhY3Rpb24STAoRaW5pdF90ZXh0X3Byb2'
        'plY3QYPCABKAsyHi5iZGwudjEuSW5pdFRleHRQcm9qZWN0UmVxdWVzdEgAUg9pbml0VGV4dFBy'
        'b2plY3QSRQoOcmVsb2FkX3Byb2plY3QYPSABKAsyHC5iZGwudjEuUmVsb2FkUHJvamVjdFJlcX'
        'Vlc3RIAFINcmVsb2FkUHJvamVjdBI8CgtnZXRfc291cmNlcxg+IAEoCzIZLmJkbC52MS5HZXRT'
        'b3VyY2VzUmVxdWVzdEgAUgpnZXRTb3VyY2VzEkwKEWFwcGx5X3NvdXJjZV9lZGl0GD8gASgLMh'
        '4uYmRsLnYxLkFwcGx5U291cmNlRWRpdFJlcXVlc3RIAFIPYXBwbHlTb3VyY2VFZGl0EkgKD3Nl'
        'bWFudGljX3Rva2VucxhAIAEoCzIdLmJkbC52MS5TZW1hbnRpY1Rva2Vuc1JlcXVlc3RIAFIOc2'
        'VtYW50aWNUb2tlbnMSTgoRc291cmNlX2NvbXBsZXRpb24YQSABKAsyHy5iZGwudjEuU291cmNl'
        'Q29tcGxldGlvblJlcXVlc3RIAFIQc291cmNlQ29tcGxldGlvbhI/Cgxzb3VyY2VfaG92ZXIYQi'
        'ABKAsyGi5iZGwudjEuU291cmNlSG92ZXJSZXF1ZXN0SABSC3NvdXJjZUhvdmVyEk4KEXNvdXJj'
        ...
        'RsLnYxLkxpc3RUZW1wbGF0ZXNSZXF1ZXN0SABSDWxpc3RUZW1wbGF0ZXMSWAoVbGlzdF92YWx1'
        'ZV9jYXRlZ29yaWVzGEwgASgLMiIuYmRsLnYxLkxpc3RWYWx1ZUNhdGVnb3JpZXNSZXF1ZXN0SA'
        'BSE2xpc3RWYWx1ZUNhdGVnb3JpZXMSSwoQbmF2aWdhdGVfZm9ybXVsYRhNIAEoCzIeLmJkbC52'
        'MS5OYXZpZ2F0ZUZvcm11bGFSZXF1ZXN0SABSD25hdmlnYXRlRm9ybXVsYRJbChZjb21wbGV0ZV'
        '9mb3JtdWxhX2NhcmV0GE4gASgLMiMuYmRsLnYxLkNvbXBsZXRlRm9ybXVsYUNhcmV0UmVxdWVz'
...
const Response$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.SourceCompletionResponse',
      '9': 0,
      '10': 'sourceCompletion'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.SourceLocationsResponse',
      '9': 0,
      '10': 'sourceLocations'
    },
    {
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.SourceCandidatesResponse',
      '9': 0,
      '10': 'sourceCandidates'
    },
    {
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.ValueCategoriesResponse',
      '9': 0,
      '10': 'valueCategories'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.NavigateFormulaResponse',
      '9': 0,
      '10': 'navigateFormula'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.FormulaSignatureResponse',
      '9': 0,
      '10': 'formulaSignature'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.FormulaRenderResponse',
      '9': 0,
      '10': 'formulaRender'
    },
    {
...
final $typed_data.Uint8List responseDescriptor = $convert
    .base64Decode('CghSZXNwb25zZRIdCgpyZXF1ZXN0X2lkGAEgASgEUglyZXF1ZXN0SWQSJQoFZXJyb3IYAiABKA'
        ...
        'c2VtYW50aWNUb2tlbnMSTwoRc291cmNlX2NvbXBsZXRpb24YMyABKAsyIC5iZGwudjEuU291cm'
        'NlQ29tcGxldGlvblJlc3BvbnNlSABSEHNvdXJjZUNvbXBsZXRpb24STAoQc291cmNlX2xvY2F0'
        ...
        'BvbnNlSABSCXRlbXBsYXRlcxJMChB2YWx1ZV9jYXRlZ29yaWVzGDogASgLMh8uYmRsLnYxLlZh'
        'bHVlQ2F0ZWdvcmllc1Jlc3BvbnNlSABSD3ZhbHVlQ2F0ZWdvcmllcxJMChBuYXZpZ2F0ZV9mb3'
...
const EditOp$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.SetDeviceSource',
      '9': 0,
      '10': 'setDeviceSource'
    },
    {
      '1': 'set_device_provider',
      '3': 33,
      '4': 1,
      '5': 11,
      '6': '.bdl.v1.SetDeviceProvider',
      '9': 0,
      '10': 'setDeviceProvider'
    },
  ],
  '8': [
    {'1': 'op'},
...
final $typed_data.Uint8List editOpDescriptor = $convert
    .base64Decode('CgZFZGl0T3ASPgoOY3JlYXRlX2NvbmNlcHQYASABKAsyFS5iZGwudjEuQ3JlYXRlQ29uY2VwdE'
        ...
        'syHC5iZGwudjEuU2V0RGV2aWNlUmVhbGl6YXRpb25IAFIUc2V0RGV2aWNlUmVhbGl6YXRpb24S'
        'RQoRc2V0X2RldmljZV9zb3VyY2UYICABKAsyFy5iZGwudjEuU2V0RGV2aWNlU291cmNlSABSD3'
        'NldERldmljZVNvdXJjZRJLChNzZXRfZGV2aWNlX3Byb3ZpZGVyGCEgASgLMhkuYmRsLnYxLlNl'
        'dERldmljZVByb3ZpZGVySABSEXNldERldmljZVByb3ZpZGVyQgQKAm9w');
...
@$core.Deprecated('Use setDeviceSourceDescriptor instead')
const SetDeviceSource$json = {
  '1': 'SetDeviceSource',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 4, '10': 'id'},
    {'1': 'source_id', '3': 2, '4': 1, '5': 4, '9': 0, '10': 'sourceId', '17': true},
  ],
  '8': [
    {'1': '_source_id'},
  ],
...
/// Descriptor for `SetDeviceSource`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List setDeviceSourceDescriptor = $convert
    .base64Decode('Cg9TZXREZXZpY2VTb3VyY2USDgoCaWQYASABKARSAmlkEiAKCXNvdXJjZV9pZBgCIAEoBEgAUg'
        'hzb3VyY2VJZIgBAUIMCgpfc291cmNlX2lk');

@$core.Deprecated('Use setDeviceProviderDescriptor instead')
const SetDeviceProvider$json = {
  '1': 'SetDeviceProvider',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 4, '10': 'id'},
    {'1': 'profile_id', '3': 2, '4': 1, '5': 9, '9': 0, '10': 'profileId', '17': true},
...
/// Descriptor for `SetDeviceProvider`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List setDeviceProviderDescriptor = $convert
    .base64Decode('ChFTZXREZXZpY2VQcm92aWRlchIOCgJpZBgBIAEoBFICaWQSIgoKcHJvZmlsZV9pZBgCIAEoCU'
        'gAUglwcm9maWxlSWSIAQESJgoEa2luZBgDIAEoDjISLmJkbC52MS5EZXZpY2VLaW5kUgRraW5k'
        'Qg0KC19wcm9maWxlX2lk');
...
const DeviceView$json = {
  ...
  '2': [
    ...
    {'1': 'source_id', '3': 8, '4': 1, '5': 4, '9': 2, '10': 'sourceId', '17': true},
    {'1': 'provider', '3': 9, '4': 1, '5': 9, '9': 3, '10': 'provider', '17': true},
  ],
  '8': [
    {'1': '_output_id'},
    {'1': '_realization'},
...
final $typed_data.Uint8List deviceViewDescriptor = $convert
    .base64Decode('CgpEZXZpY2VWaWV3Eg4KAmlkGAEgASgEUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEiYKBGtpbm'
        ...
        'cmVxdWlyZW1lbnRzEiUKC3JlYWxpemF0aW9uGAcgASgJSAFSC3JlYWxpemF0aW9uiAEBEiAKCX'
        'NvdXJjZV9pZBgIIAEoBEgCUghzb3VyY2VJZIgBARIfCghwcm92aWRlchgJIAEoCUgDUghwcm92'
        'aWRlcogBAUIMCgpfb3V0cHV0X2lkQg4KDF9yZWFsaXphdGlvbkIMCgpfc291cmNlX2lkQgsKCV'
        '9wcm92aWRlcg==');
...
final $typed_data.Uint8List mappingAnalysisDescriptor = $convert
    .base64Decode('Cg9NYXBwaW5nQW5hbHlzaXMSDgoCaWQYASABKARSAmlkEi0KBnN0YXR1cxgCIAEoDjIVLmJkbC'
        ...
        'UgRyb2xlEhQKBXNsb3RzGAogAygJUgVzbG90cw==');
...
const FormulaNode$json = {
  ...
  '2': [
    ...
    {'1': 'unit_source', '3': 19, '4': 1, '5': 9, '10': 'unitSource'},
    {'1': 'unit_display', '3': 20, '4': 1, '5': 9, '10': 'unitDisplay'},
    ...
    {'1': 'role', '3': 21, '4': 1, '5': 9, '10': 'role'},
    {'1': 'locals', '3': 22, '4': 3, '5': 9, '10': 'locals'},
    {'1': 'binds', '3': 23, '4': 3, '5': 9, '10': 'binds'},
    {'1': 'append_at', '3': 24, '4': 1, '5': 13, '9': 4, '10': 'appendAt', '17': true},
  ],
  '8': [
    {'1': '_entity'},
    {'1': '_actual'},
...
final $typed_data.Uint8List formulaNodeDescriptor = $convert
    .base64Decode('CgtGb3JtdWxhTm9kZRIOCgJpZBgBIAEoCVICaWQSKAoFcmFuZ2UYAiABKAsyEi5iZGwudjEuU2'
        ...
        'R1bml0GAcgASgJUgR1bml0EhcKB3VuaXRfaWQYCCABKAlSBnVuaXRJZBIfCgt1bml0X3NvdXJj'
        'ZRgTIAEoCVIKdW5pdFNvdXJjZRIhCgx1bml0X2Rpc3BsYXkYFCABKAlSC3VuaXREaXNwbGF5Eh'
        'oKCGVxdWF0aW9uGAkgASgIUghlcXVhdGlvbhIuCgZlbnRpdHkYCiABKAsyES5iZGwudjEuRW50'
        'aXR5UmVmSABSBmVudGl0eYgBARItCgZhY3R1YWwYCyABKAsyEC5iZGwudjEuVHlwZVZpZXdIAV'
        'IGYWN0dWFsiAEBEjEKCGV4cGVjdGVkGAwgASgLMhAuYmRsLnYxLlR5cGVWaWV3SAJSCGV4cGVj'
        'dGVkiAEBEhgKB2JlY2F1c2UYDSABKAlSB2JlY2F1c2USNAoLZGlhZ25vc3RpY3MYDiADKAsyEi'
        '5iZGwudjEuRGlhZ25vc3RpY1ILZGlhZ25vc3RpY3MSLwoIY2hpbGRyZW4YDyADKAsyEy5iZGwu'
        'djEuRm9ybXVsYU5vZGVSCGNoaWxkcmVuEhQKBWxvY2FsGBAgASgIUgVsb2NhbBIUCgVwYXJhbR'
        'gRIAEoCVIFcGFyYW0SNAoKcGFyYW1fdHlwZRgSIAEoCzIQLmJkbC52MS5UeXBlVmlld0gDUglw'
        'YXJhbVR5cGWIAQESEgoEcm9sZRgVIAEoCVIEcm9sZRIWCgZsb2NhbHMYFiADKAlSBmxvY2Fscx'
        'IUCgViaW5kcxgXIAMoCVIFYmluZHMSIAoJYXBwZW5kX2F0GBggASgNSARSCGFwcGVuZEF0iAEB'
        'QgkKB19lbnRpdHlCCQoHX2FjdHVhbEILCglfZXhwZWN0ZWRCDQoLX3BhcmFtX3R5cGVCDAoKX2'
        'FwcGVuZF9hdA==');

@$core.Deprecated('Use navigateFormulaRequestDescriptor instead')
const NavigateFormulaRequest$json = {
  '1': 'NavigateFormulaRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'mapping_id', '3': 2, '4': 1, '5': 4, '10': 'mappingId'},
    {'1': 'source', '3': 3, '4': 1, '5': 9, '10': 'source'},
    {'1': 'node_id', '3': 4, '4': 1, '5': 9, '10': 'nodeId'},
    {'1': 'side', '3': 5, '4': 1, '5': 14, '6': '.bdl.v1.CaretSide', '10': 'side'},
    {'1': 'motion', '3': 6, '4': 1, '5': 14, '6': '.bdl.v1.CaretMotion', '10': 'motion'},
    {'1': 'component', '3': 7, '4': 1, '5': 4, '9': 0, '10': 'component', '17': true},
  ],
  '8': [
    {'1': '_component'},
  ],
...
/// Descriptor for `NavigateFormulaRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List navigateFormulaRequestDescriptor = $convert
    .base64Decode('ChZOYXZpZ2F0ZUZvcm11bGFSZXF1ZXN0EhoKCHJldmlzaW9uGAEgASgEUghyZXZpc2lvbhIdCg'
        'ptYXBwaW5nX2lkGAIgASgEUgltYXBwaW5nSWQSFgoGc291cmNlGAMgASgJUgZzb3VyY2USFwoH'
        'bm9kZV9pZBgEIAEoCVIGbm9kZUlkEiUKBHNpZGUYBSABKA4yES5iZGwudjEuQ2FyZXRTaWRlUg'
        'RzaWRlEisKBm1vdGlvbhgGIAEoDjITLmJkbC52MS5DYXJldE1vdGlvblIGbW90aW9uEiEKCWNv'
        'bXBvbmVudBgHIAEoBEgAUgljb21wb25lbnSIAQFCDAoKX2NvbXBvbmVudA==');

@$core.Deprecated('Use navigateFormulaResponseDescriptor instead')
const NavigateFormulaResponse$json = {
  '1': 'NavigateFormulaResponse',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'mapping_id', '3': 2, '4': 1, '5': 4, '10': 'mappingId'},
    {'1': 'node_id', '3': 3, '4': 1, '5': 9, '10': 'nodeId'},
    {'1': 'side', '3': 4, '4': 1, '5': 14, '6': '.bdl.v1.CaretSide', '10': 'side'},
    {'1': 'offset', '3': 5, '4': 1, '5': 13, '10': 'offset'},
  ],
};

/// Descriptor for `NavigateFormulaResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List navigateFormulaResponseDescriptor = $convert
    .base64Decode('ChdOYXZpZ2F0ZUZvcm11bGFSZXNwb25zZRIaCghyZXZpc2lvbhgBIAEoBFIIcmV2aXNpb24SHQ'
        'oKbWFwcGluZ19pZBgCIAEoBFIJbWFwcGluZ0lkEhcKB25vZGVfaWQYAyABKAlSBm5vZGVJZBIl'
        'CgRzaWRlGAQgASgOMhEuYmRsLnYxLkNhcmV0U2lkZVIEc2lkZRIWCgZvZmZzZXQYBSABKA1SBm'
        '9mZnNldA==');

@$core.Deprecated('Use completeFormulaCaretRequestDescriptor instead')
const CompleteFormulaCaretRequest$json = {
  '1': 'CompleteFormulaCaretRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'mapping_id', '3': 2, '4': 1, '5': 4, '10': 'mappingId'},
    {'1': 'source', '3': 3, '4': 1, '5': 9, '10': 'source'},
...
/// Descriptor for `CompleteFormulaCaretRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List completeFormulaCaretRequestDescriptor = $convert
    .base64Decode('ChtDb21wbGV0ZUZvcm11bGFDYXJldFJlcXVlc3QSGgoIcmV2aXNpb24YASABKARSCHJldmlzaW'
        '9uEh0KCm1hcHBpbmdfaWQYAiABKARSCW1hcHBpbmdJZBIWCgZzb3VyY2UYAyABKAlSBnNvdXJj'
        'ZRIXCgdub2RlX2lkGAQgASgJUgZub2RlSWQSJQoEc2lkZRgFIAEoDjIRLmJkbC52MS5DYXJldF'
        'NpZGVSBHNpZGUSFgoGcHJlZml4GAYgASgJUgZwcmVmaXgSIQoJY29tcG9uZW50GAcgASgESABS'
        'CWNvbXBvbmVudIgBAUIMCgpfY29tcG9uZW50');

@$core.Deprecated('Use getFormulaSignatureRequestDescriptor instead')
const GetFormulaSignatureRequest$json = {
  '1': 'GetFormulaSignatureRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'mapping_id', '3': 2, '4': 1, '5': 4, '10': 'mappingId'},
    {'1': 'source', '3': 3, '4': 1, '5': 9, '10': 'source'},
...
/// Descriptor for `GetFormulaSignatureRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getFormulaSignatureRequestDescriptor = $convert
    .base64Decode('ChpHZXRGb3JtdWxhU2lnbmF0dXJlUmVxdWVzdBIaCghyZXZpc2lvbhgBIAEoBFIIcmV2aXNpb2'
        '4SHQoKbWFwcGluZ19pZBgCIAEoBFIJbWFwcGluZ0lkEhYKBnNvdXJjZRgDIAEoCVIGc291cmNl'
        'EhcKB25vZGVfaWQYBCABKAlSBm5vZGVJZBIhCgljb21wb25lbnQYBSABKARIAFIJY29tcG9uZW'
        '50iAEBQgwKCl9jb21wb25lbnQ=');

@$core.Deprecated('Use formulaSignatureResponseDescriptor instead')
const FormulaSignatureResponse$json = {
  '1': 'FormulaSignatureResponse',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'mapping_id', '3': 2, '4': 1, '5': 4, '10': 'mappingId'},
    ...
    {'1': 'parameters', '3': 7, '4': 3, '5': 11, '6': '.bdl.v1.ParameterHelp', '10': 'parameters'},
    {'1': 'result', '3': 8, '4': 1, '5': 9, '10': 'result'},
    {'1': 'active', '3': 9, '4': 1, '5': 13, '9': 0, '10': 'active', '17': true},
    {'1': 'summary', '3': 10, '4': 1, '5': 9, '10': 'summary'},
  ],
  '8': [
    {'1': '_active'},
  ],
...
/// Descriptor for `FormulaSignatureResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List formulaSignatureResponseDescriptor = $convert
    .base64Decode('ChhGb3JtdWxhU2lnbmF0dXJlUmVzcG9uc2USGgoIcmV2aXNpb24YASABKARSCHJldmlzaW9uEh'
        '0KCm1hcHBpbmdfaWQYAiABKARSCW1hcHBpbmdJZBIUCgVmb3VuZBgDIAEoCFIFZm91bmQSFwoH'
        'bm9kZV9pZBgEIAEoCVIGbm9kZUlkEhIKBG5hbWUYBSABKAlSBG5hbWUSFAoFc2hhcGUYBiABKA'
        'lSBXNoYXBlEjUKCnBhcmFtZXRlcnMYByADKAsyFS5iZGwudjEuUGFyYW1ldGVySGVscFIKcGFy'
        'YW1ldGVycxIWCgZyZXN1bHQYCCABKAlSBnJlc3VsdBIbCgZhY3RpdmUYCSABKA1IAFIGYWN0aX'
        'ZliAEBEhgKB3N1bW1hcnkYCiABKAlSB3N1bW1hcnlCCQoHX2FjdGl2ZQ==');

@$core.Deprecated('Use parameterHelpDescriptor instead')
const ParameterHelp$json = {
  '1': 'ParameterHelp',
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
...
/// Descriptor for `ParameterHelp`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List parameterHelpDescriptor = $convert
    .base64Decode('Cg1QYXJhbWV0ZXJIZWxwEhIKBG5hbWUYASABKAlSBG5hbWUSGgoIZXhwZWN0ZWQYAiABKAlSCG'
        'V4cGVjdGVk');

@$core.Deprecated('Use getFormulaRenderRequestDescriptor instead')
const GetFormulaRenderRequest$json = {
  '1': 'GetFormulaRenderRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'mapping_id', '3': 2, '4': 1, '5': 4, '10': 'mappingId'},
    {'1': 'component', '3': 3, '4': 1, '5': 4, '9': 0, '10': 'component', '17': true},
...
/// Descriptor for `GetFormulaRenderRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getFormulaRenderRequestDescriptor = $convert
    .base64Decode('ChdHZXRGb3JtdWxhUmVuZGVyUmVxdWVzdBIaCghyZXZpc2lvbhgBIAEoBFIIcmV2aXNpb24SHQ'
        'oKbWFwcGluZ19pZBgCIAEoBFIJbWFwcGluZ0lkEiEKCWNvbXBvbmVudBgDIAEoBEgAUgljb21w'
        'b25lbnSIAQFCDAoKX2NvbXBvbmVudA==');

@$core.Deprecated('Use formulaRenderResponseDescriptor instead')
const FormulaRenderResponse$json = {
  '1': 'FormulaRenderResponse',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'mapping_id', '3': 2, '4': 1, '5': 4, '10': 'mappingId'},
    {'1': 'fragments', '3': 3, '4': 3, '5': 11, '6': '.bdl.v1.FormulaFragment', '10': 'fragments'},
    {'1': 'compact', '3': 4, '4': 1, '5': 9, '10': 'compact'},
    {'1': 'result', '3': 5, '4': 1, '5': 9, '10': 'result'},
    {'1': 'error_count', '3': 6, '4': 1, '5': 13, '10': 'errorCount'},
    {'1': 'warning_count', '3': 7, '4': 1, '5': 13, '10': 'warningCount'},
    {'1': 'references', '3': 8, '4': 3, '5': 9, '10': 'references'},
  ],
};

/// Descriptor for `FormulaRenderResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List formulaRenderResponseDescriptor = $convert
    .base64Decode('ChVGb3JtdWxhUmVuZGVyUmVzcG9uc2USGgoIcmV2aXNpb24YASABKARSCHJldmlzaW9uEh0KCm'
        '1hcHBpbmdfaWQYAiABKARSCW1hcHBpbmdJZBI1CglmcmFnbWVudHMYAyADKAsyFy5iZGwudjEu'
        'Rm9ybXVsYUZyYWdtZW50UglmcmFnbWVudHMSGAoHY29tcGFjdBgEIAEoCVIHY29tcGFjdBIWCg'
        'ZyZXN1bHQYBSABKAlSBnJlc3VsdBIfCgtlcnJvcl9jb3VudBgGIAEoDVIKZXJyb3JDb3VudBIj'
        'Cg13YXJuaW5nX2NvdW50GAcgASgNUgx3YXJuaW5nQ291bnQSHgoKcmVmZXJlbmNlcxgIIAMoCV'
        'IKcmVmZXJlbmNlcw==');

@$core.Deprecated('Use formulaFragmentDescriptor instead')
const FormulaFragment$json = {
  '1': 'FormulaFragment',
  '2': [
    {'1': 'text', '3': 1, '4': 1, '5': 9, '10': 'text'},
    {'1': 'kind', '3': 2, '4': 1, '5': 9, '10': 'kind'},
    {'1': 'node_id', '3': 3, '4': 1, '5': 9, '10': 'nodeId'},
    {'1': 'range', '3': 4, '4': 1, '5': 11, '6': '.bdl.v1.SourceSpan', '10': 'range'},
  ],
};

/// Descriptor for `FormulaFragment`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List formulaFragmentDescriptor = $convert
    .base64Decode('Cg9Gb3JtdWxhRnJhZ21lbnQSEgoEdGV4dBgBIAEoCVIEdGV4dBISCgRraW5kGAIgASgJUgRraW'
        '5kEhcKB25vZGVfaWQYAyABKAlSBm5vZGVJZBIoCgVyYW5nZRgEIAEoCzISLmJkbC52MS5Tb3Vy'
        'Y2VTcGFuUgVyYW5nZQ==');
...
final $typed_data.Uint8List unitCandidateDescriptor = $convert
    .base64Decode('Cg1Vbml0Q2FuZGlkYXRlEg4KAmlkGAEgASgJUgJpZBIWCgZzeW1ib2wYAiABKAlSBnN5bWJvbB'
        'IaCghtZWFzdXJlcxgDIAEoCVIIbWVhc3VyZXMSGAoHZGlzcGxheRgEIAEoCVIHZGlzcGxheQ==');
...
@$core.Deprecated('Use composeInsertDescriptor instead')
const ComposeInsert$json = {
  '1': 'ComposeInsert',
  '2': [
    {'1': 'side', '3': 1, '4': 1, '5': 14, '6': '.bdl.v1.CaretSide', '10': 'side'},
    {'1': 'text', '3': 2, '4': 1, '5': 9, '10': 'text'},
  ],
};

/// Descriptor for `ComposeInsert`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List composeInsertDescriptor = $convert
    .base64Decode('Cg1Db21wb3NlSW5zZXJ0EiUKBHNpZGUYASABKA4yES5iZGwudjEuQ2FyZXRTaWRlUgRzaWRlEh'
...
const DraftCompletionItem$json = {
  ...
  '2': [
    ...
    {'1': 'structured_insert', '3': 9, '4': 1, '5': 9, '10': 'structuredInsert'},
  ],
};
...
final $typed_data.Uint8List draftCompletionItemDescriptor = $convert
    .base64Decode('ChNEcmFmdENvbXBsZXRpb25JdGVtEhQKBWxhYmVsGAEgASgJUgVsYWJlbBISCgRraW5kGAIgAS'
        ...
        'b2N1bWVudGF0aW9uEhwKCXJlbGV2YW5jZRgIIAEoDVIJcmVsZXZhbmNlEisKEXN0cnVjdHVyZW'
        'RfaW5zZXJ0GAkgASgJUhBzdHJ1Y3R1cmVkSW5zZXJ0');
...
const DraftHoverResponse$json = {
  ...
  '2': [
    ...
    {'1': 'equation', '3': 14, '4': 1, '5': 9, '10': 'equation'},
  ],
  '8': [
    {'1': '_span'},
    {'1': '_concept_id'},
...
final $typed_data.Uint8List draftHoverResponseDescriptor = $convert
    .base64Decode('ChJEcmFmdEhvdmVyUmVzcG9uc2USGgoIcmV2aXNpb24YASABKARSCHJldmlzaW9uEh0KCm1hcH'
        ...
        'cGVuEhoKCGVxdWF0aW9uGA4gASgJUghlcXVhdGlvbkIHCgVfc3BhbkINCgtfY29uY2VwdF9pZE'
        'IJCgdfZW50aXR5');
...
final $typed_data.Uint8List quantityViewDescriptor = $convert
    .base64Decode('CgxRdWFudGl0eVZpZXcSDgoCaWQYASABKAlSAmlkEhsKCXR5cGVfbmFtZRgCIAEoCVIIdHlwZU'
        '5hbWUSEgoEdW5pdBgDIAEoCVIEdW5pdBIdCgNkaW0YBCABKAsyCy5iZGwudjEuRGltUgNkaW0S'
        'QAoOcHJlZmVycmVkX3VuaXQYBSABKAsyFC5iZGwudjEuVW5pdEV4cHJWaWV3SABSDXByZWZlcn'
        'JlZFVuaXSIAQFCEQoPX3ByZWZlcnJlZF91bml0');

@$core.Deprecated('Use unitExprViewDescriptor instead')
const UnitExprView$json = {
  '1': 'UnitExprView',
  '2': [
    {'1': 'source', '3': 1, '4': 1, '5': 9, '10': 'source'},
    {'1': 'display', '3': 2, '4': 1, '5': 9, '10': 'display'},
    {'1': 'dim', '3': 3, '4': 1, '5': 11, '6': '.bdl.v1.Dim', '10': 'dim'},
    {'1': 'atom_id', '3': 4, '4': 1, '5': 9, '10': 'atomId'},
    {'1': 'factors', '3': 5, '4': 3, '5': 11, '6': '.bdl.v1.UnitFactorView', '10': 'factors'},
  ],
};

/// Descriptor for `UnitExprView`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List unitExprViewDescriptor = $convert
    .base64Decode('CgxVbml0RXhwclZpZXcSFgoGc291cmNlGAEgASgJUgZzb3VyY2USGAoHZGlzcGxheRgCIAEoCV'
        'IHZGlzcGxheRIdCgNkaW0YAyABKAsyCy5iZGwudjEuRGltUgNkaW0SFwoHYXRvbV9pZBgEIAEo'
        'CVIGYXRvbUlkEjAKB2ZhY3RvcnMYBSADKAsyFi5iZGwudjEuVW5pdEZhY3RvclZpZXdSB2ZhY3'
        'RvcnM=');

@$core.Deprecated('Use unitFactorViewDescriptor instead')
const UnitFactorView$json = {
  '1': 'UnitFactorView',
  '2': [
    {'1': 'atom_id', '3': 1, '4': 1, '5': 9, '10': 'atomId'},
    {'1': 'symbol', '3': 2, '4': 1, '5': 9, '10': 'symbol'},
    {'1': 'exponent', '3': 3, '4': 1, '5': 17, '10': 'exponent'},
  ],
};

/// Descriptor for `UnitFactorView`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List unitFactorViewDescriptor = $convert
    .base64Decode('Cg5Vbml0RmFjdG9yVmlldxIXCgdhdG9tX2lkGAEgASgJUgZhdG9tSWQSFgoGc3ltYm9sGAIgAS'
        'gJUgZzeW1ib2wSGgoIZXhwb25lbnQYAyABKBFSCGV4cG9uZW50');

@$core.Deprecated('Use listValueCategoriesRequestDescriptor instead')
const ListValueCategoriesRequest$json = {
  '1': 'ListValueCategoriesRequest',
};

/// Descriptor for `ListValueCategoriesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listValueCategoriesRequestDescriptor =
    $convert.base64Decode('ChpMaXN0VmFsdWVDYXRlZ29yaWVzUmVxdWVzdA==');

@$core.Deprecated('Use valueCategoriesResponseDescriptor instead')
const ValueCategoriesResponse$json = {
  '1': 'ValueCategoriesResponse',
  '2': [
    {
      '1': 'categories',
      '3': 1,
      '4': 3,
      '5': 11,
      '6': '.bdl.v1.ValueCategoryView',
      '10': 'categories'
    },
  ],
};

/// Descriptor for `ValueCategoriesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List valueCategoriesResponseDescriptor = $convert
    .base64Decode('ChdWYWx1ZUNhdGVnb3JpZXNSZXNwb25zZRI5CgpjYXRlZ29yaWVzGAEgAygLMhkuYmRsLnYxLl'
        'ZhbHVlQ2F0ZWdvcnlWaWV3UgpjYXRlZ29yaWVz');

@$core.Deprecated('Use valueCategoryViewDescriptor instead')
const ValueCategoryView$json = {
  '1': 'ValueCategoryView',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    {'1': 'display_name', '3': 2, '4': 1, '5': 9, '10': 'displayName'},
    ...
    {'1': 'dim', '3': 5, '4': 1, '5': 11, '6': '.bdl.v1.Dim', '9': 0, '10': 'dim', '17': true},
    {
      '1': 'preferred_unit',
      '3': 6,
      '4': 1,
    ...
    {'1': 'units', '3': 7, '4': 3, '5': 11, '6': '.bdl.v1.UnitExprView', '10': 'units'},
  ],
  '8': [
    {'1': '_dim'},
    {'1': '_preferred_unit'},
...
/// Descriptor for `ValueCategoryView`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List valueCategoryViewDescriptor = $convert
    .base64Decode('ChFWYWx1ZUNhdGVnb3J5VmlldxIOCgJpZBgBIAEoCVICaWQSIQoMZGlzcGxheV9uYW1lGAIgAS'
        'gJUgtkaXNwbGF5TmFtZRIbCgl0eXBlX25hbWUYAyABKAlSCHR5cGVOYW1lEj4KDnJlcHJlc2Vu'
        'dGF0aW9uGAQgASgLMhYuYmRsLnYxLlJlcHJlc2VudGF0aW9uUg5yZXByZXNlbnRhdGlvbhIiCg'
        'NkaW0YBSABKAsyCy5iZGwudjEuRGltSABSA2RpbYgBARJACg5wcmVmZXJyZWRfdW5pdBgGIAEo'
        'CzIULmJkbC52MS5Vbml0RXhwclZpZXdIAVINcHJlZmVycmVkVW5pdIgBARIqCgV1bml0cxgHIA'
        'MoCzIULmJkbC52MS5Vbml0RXhwclZpZXdSBXVuaXRzQgYKBF9kaW1CEQoPX3ByZWZlcnJlZF91'
        'bml0');
...
final $typed_data.Uint8List libraryItemViewDescriptor = $convert
    .base64Decode('Cg9MaWJyYXJ5SXRlbVZpZXcSDgoCaWQYASABKAlSAmlkEhoKCGNhdGVnb3J5GAIgASgJUghjYX'
        ...
        'YxLkNvbmNlcHRUZW1wbGF0ZVZpZXdIAFIHY29uY2VwdIgBARI1CgZwcmVzZXQYCiABKAsyGC5i'
        'ZGwudjEuU291cmNlUHJlc2V0Vmlld0gBUgZwcmVzZXSIAQFCCgoIX2NvbmNlcHRCCQoHX3ByZX'
        'NldA==');

@$core.Deprecated('Use sourcePresetViewDescriptor instead')
const SourcePresetView$json = {
  '1': 'SourcePresetView',
  '2': [
    {'1': 'concept_name', '3': 1, '4': 1, '5': 9, '10': 'conceptName'},
    {'1': 'concept_description', '3': 2, '4': 1, '5': 9, '10': 'conceptDescription'},
    {
      '1': 'representation',
      '3': 3,
      '4': 1,
    ...
    {'1': 'source_name', '3': 6, '4': 1, '5': 9, '10': 'sourceName'},
    {'1': 'source_description', '3': 7, '4': 1, '5': 9, '10': 'sourceDescription'},
  ],
  '8': [
    {'1': '_representation'},
  ],
...
/// Descriptor for `SourcePresetView`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourcePresetViewDescriptor = $convert
    .base64Decode('ChBTb3VyY2VQcmVzZXRWaWV3EiEKDGNvbmNlcHRfbmFtZRgBIAEoCVILY29uY2VwdE5hbWUSLw'
        'oTY29uY2VwdF9kZXNjcmlwdGlvbhgCIAEoCVISY29uY2VwdERlc2NyaXB0aW9uEkMKDnJlcHJl'
        'c2VudGF0aW9uGAMgASgLMhYuYmRsLnYxLlJlcHJlc2VudGF0aW9uSABSDnJlcHJlc2VudGF0aW'
        '9uiAEBEhsKCXR5cGVfbmFtZRgEIAEoCVIIdHlwZU5hbWUSEgoEdW5pdBgFIAEoCVIEdW5pdBIf'
        'Cgtzb3VyY2VfbmFtZRgGIAEoCVIKc291cmNlTmFtZRItChJzb3VyY2VfZGVzY3JpcHRpb24YBy'
        'ABKAlSEXNvdXJjZURlc2NyaXB0aW9uQhEKD19yZXByZXNlbnRhdGlvbg==');
...
const CreateSourceRequest$json = {
  ...
  '2': [
    {'1': 'base_revision', '3': 1, '4': 1, '5': 4, '10': 'baseRevision'},
    {'1': 'component', '3': 2, '4': 1, '5': 4, '9': 1, '10': 'component', '17': true},
    {'1': 'source_name', '3': 3, '4': 1, '5': 9, '10': 'sourceName'},
    {'1': 'source_description', '3': 4, '4': 1, '5': 9, '10': 'sourceDescription'},
    {'1': 'existing_concept', '3': 5, '4': 1, '5': 4, '9': 0, '10': 'existingConcept'},
    {
      '1': 'new_concept',
      '3': 6,
      '4': 1,
...
final $typed_data.Uint8List createSourceRequestDescriptor = $convert
    .base64Decode('ChNDcmVhdGVTb3VyY2VSZXF1ZXN0EiMKDWJhc2VfcmV2aXNpb24YASABKARSDGJhc2VSZXZpc2'
        'lvbhIhCgljb21wb25lbnQYAiABKARIAVIJY29tcG9uZW50iAEBEh8KC3NvdXJjZV9uYW1lGAMg'
        'ASgJUgpzb3VyY2VOYW1lEi0KEnNvdXJjZV9kZXNjcmlwdGlvbhgEIAEoCVIRc291cmNlRGVzY3'
        'JpcHRpb24SKwoQZXhpc3RpbmdfY29uY2VwdBgFIAEoBEgAUg9leGlzdGluZ0NvbmNlcHQSNQoL'
        'bmV3X2NvbmNlcHQYBiABKAsyEi5iZGwudjEuTmV3Q29uY2VwdEgAUgpuZXdDb25jZXB0QgkKB2'
        'NvbmNlcHRCDAoKX2NvbXBvbmVudA==');

@$core.Deprecated('Use newConceptDescriptor instead')
const NewConcept$json = {
  '1': 'NewConcept',
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {'1': 'description', '3': 2, '4': 1, '5': 9, '10': 'description'},
    ...
    {'1': 'category_id', '3': 4, '4': 1, '5': 9, '9': 1, '10': 'categoryId', '17': true},
  ],
  '8': [
    {'1': '_representation'},
    {'1': '_category_id'},
...
/// Descriptor for `NewConcept`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List newConceptDescriptor = $convert
    .base64Decode('CgpOZXdDb25jZXB0EhIKBG5hbWUYASABKAlSBG5hbWUSIAoLZGVzY3JpcHRpb24YAiABKAlSC2'
        'Rlc2NyaXB0aW9uEkMKDnJlcHJlc2VudGF0aW9uGAMgASgLMhYuYmRsLnYxLlJlcHJlc2VudGF0'
        'aW9uSABSDnJlcHJlc2VudGF0aW9uiAEBEiQKC2NhdGVnb3J5X2lkGAQgASgJSAFSCmNhdGVnb3'
        'J5SWSIAQFCEQoPX3JlcHJlc2VudGF0aW9uQg4KDF9jYXRlZ29yeV9pZA==');

@$core.Deprecated('Use listSourceCandidatesRequestDescriptor instead')
const ListSourceCandidatesRequest$json = {
  '1': 'ListSourceCandidatesRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'component', '3': 2, '4': 1, '5': 4, '9': 0, '10': 'component', '17': true},
...
/// Descriptor for `ListSourceCandidatesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listSourceCandidatesRequestDescriptor = $convert
    .base64Decode('ChtMaXN0U291cmNlQ2FuZGlkYXRlc1JlcXVlc3QSGgoIcmV2aXNpb24YASABKARSCHJldmlzaW'
        '9uEiEKCWNvbXBvbmVudBgCIAEoBEgAUgljb21wb25lbnSIAQESFwoHaXRlbV9pZBgDIAEoCVIG'
        'aXRlbUlkQgwKCl9jb21wb25lbnQ=');

@$core.Deprecated('Use sourceCandidatesResponseDescriptor instead')
const SourceCandidatesResponse$json = {
  '1': 'SourceCandidatesResponse',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {
      '1': 'candidates',
    ...
    {'1': 'suggested_concept_name', '3': 4, '4': 1, '5': 9, '10': 'suggestedConceptName'},
    {'1': 'suggested_source_name', '3': 5, '4': 1, '5': 9, '10': 'suggestedSourceName'},
  ],
  '8': [
    {'1': '_preset'},
  ],
...
/// Descriptor for `SourceCandidatesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceCandidatesResponseDescriptor = $convert
    .base64Decode('ChhTb3VyY2VDYW5kaWRhdGVzUmVzcG9uc2USGgoIcmV2aXNpb24YASABKARSCHJldmlzaW9uEj'
        'sKCmNhbmRpZGF0ZXMYAiADKAsyGy5iZGwudjEuU291cmNlQ2FuZGlkYXRlVmlld1IKY2FuZGlk'
        'YXRlcxI1CgZwcmVzZXQYAyABKAsyGC5iZGwudjEuU291cmNlUHJlc2V0Vmlld0gAUgZwcmVzZX'
        'SIAQESNAoWc3VnZ2VzdGVkX2NvbmNlcHRfbmFtZRgEIAEoCVIUc3VnZ2VzdGVkQ29uY2VwdE5h'
        'bWUSMgoVc3VnZ2VzdGVkX3NvdXJjZV9uYW1lGAUgASgJUhNzdWdnZXN0ZWRTb3VyY2VOYW1lQg'
        'kKB19wcmVzZXQ=');

@$core.Deprecated('Use sourceCandidateViewDescriptor instead')
const SourceCandidateView$json = {
  '1': 'SourceCandidateView',
  '2': [
    {'1': 'concept_id', '3': 1, '4': 1, '5': 4, '10': 'conceptId'},
    {'1': 'preferred', '3': 2, '4': 1, '5': 8, '10': 'preferred'},
  ],
};

/// Descriptor for `SourceCandidateView`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceCandidateViewDescriptor = $convert
    .base64Decode('ChNTb3VyY2VDYW5kaWRhdGVWaWV3Eh0KCmNvbmNlcHRfaWQYASABKARSCWNvbmNlcHRJZBIcCg'
        'lwcmVmZXJyZWQYAiABKAhSCXByZWZlcnJlZA==');
...
const ProvisionView$json = {
  '1': 'ProvisionView',
  '2': [
    {'1': 'source_id', '3': 1, '4': 1, '5': 4, '10': 'sourceId'},
    {'1': 'source_name', '3': 2, '4': 1, '5': 9, '10': 'sourceName'},
    {'1': 'device_id', '3': 3, '4': 1, '5': 4, '9': 0, '10': 'deviceId', '17': true},
    {'1': 'device_name', '3': 4, '4': 1, '5': 9, '10': 'deviceName'},
    {'1': 'profile_id', '3': 5, '4': 1, '5': 9, '9': 1, '10': 'profileId', '17': true},
    {'1': 'status', '3': 6, '4': 1, '5': 14, '6': '.bdl.v1.ProvisionStatus', '10': 'status'},
    {'1': 'profile_known', '3': 7, '4': 1, '5': 8, '10': 'profileKnown'},
    {'1': 'transducer_well_formed', '3': 8, '4': 1, '5': 8, '10': 'transducerWellFormed'},
    {'1': 'representation_fits', '3': 9, '4': 1, '5': 8, '10': 'representationFits'},
    {'1': 'hardware_placed', '3': 10, '4': 1, '5': 8, '10': 'hardwarePlaced'},
    {'1': 'backend_supported', '3': 11, '4': 1, '5': 8, '10': 'backendSupported'},
    {'1': 'message', '3': 12, '4': 1, '5': 9, '10': 'message'},
    {'1': 'explanation', '3': 13, '4': 1, '5': 9, '10': 'explanation'},
    {
      '1': 'candidates',
      '3': 14,
      '4': 3,
      '5': 11,
      '6': '.bdl.v1.InputProfileView',
      '10': 'candidates'
    },
  ],
  '8': [
...
/// Descriptor for `ProvisionView`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List provisionViewDescriptor = $convert
    .base64Decode('Cg1Qcm92aXNpb25WaWV3EhsKCXNvdXJjZV9pZBgBIAEoBFIIc291cmNlSWQSHwoLc291cmNlX2'
        '5hbWUYAiABKAlSCnNvdXJjZU5hbWUSIAoJZGV2aWNlX2lkGAMgASgESABSCGRldmljZUlkiAEB'
        'Eh8KC2RldmljZV9uYW1lGAQgASgJUgpkZXZpY2VOYW1lEiIKCnByb2ZpbGVfaWQYBSABKAlIAV'
        'IJcHJvZmlsZUlkiAEBEi8KBnN0YXR1cxgGIAEoDjIXLmJkbC52MS5Qcm92aXNpb25TdGF0dXNS'
        'BnN0YXR1cxIjCg1wcm9maWxlX2tub3duGAcgASgIUgxwcm9maWxlS25vd24SNAoWdHJhbnNkdW'
        'Nlcl93ZWxsX2Zvcm1lZBgIIAEoCFIUdHJhbnNkdWNlcldlbGxGb3JtZWQSLwoTcmVwcmVzZW50'
        'YXRpb25fZml0cxgJIAEoCFIScmVwcmVzZW50YXRpb25GaXRzEicKD2hhcmR3YXJlX3BsYWNlZB'
        'gKIAEoCFIOaGFyZHdhcmVQbGFjZWQSKwoRYmFja2VuZF9zdXBwb3J0ZWQYCyABKAhSEGJhY2tl'
        'bmRTdXBwb3J0ZWQSGAoHbWVzc2FnZRgMIAEoCVIHbWVzc2FnZRIgCgtleHBsYW5hdGlvbhgNIA'
        'EoCVILZXhwbGFuYXRpb24SOAoKY2FuZGlkYXRlcxgOIAMoCzIYLmJkbC52MS5JbnB1dFByb2Zp'
        'bGVWaWV3UgpjYW5kaWRhdGVzQgwKCl9kZXZpY2VfaWRCDQoLX3Byb2ZpbGVfaWQ=');

@$core.Deprecated('Use inputProfileViewDescriptor instead')
const InputProfileView$json = {
  '1': 'InputProfileView',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    {'1': 'display_name', '3': 2, '4': 1, '5': 9, '10': 'displayName'},
...
/// Descriptor for `InputProfileView`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List inputProfileViewDescriptor = $convert
    .base64Decode('ChBJbnB1dFByb2ZpbGVWaWV3Eg4KAmlkGAEgASgJUgJpZBIhCgxkaXNwbGF5X25hbWUYAiABKA'
        'lSC2Rpc3BsYXlOYW1lEiAKC2Rlc2NyaXB0aW9uGAMgASgJUgtkZXNjcmlwdGlvbhImCgRraW5k'
        'GAQgASgOMhIuYmRsLnYxLkRldmljZUtpbmRSBGtpbmQSGQoIcmF3X3R5cGUYBSABKAlSB3Jhd1'
        'R5cGUSJgoOcmVwcmVzZW50YXRpb24YBiABKAlSDnJlcHJlc2VudGF0aW9uEh4KCmNvbXBhdGli'
        'bGUYByABKAhSCmNvbXBhdGlibGUSFgoGb3JpZ2luGAggASgJUgZvcmlnaW4=');
...
@$core.Deprecated('Use sourceCompletionRequestDescriptor instead')
const SourceCompletionRequest$json = {
  '1': 'SourceCompletionRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'generation', '3': 2, '4': 1, '5': 4, '10': 'generation'},
...
/// Descriptor for `SourceCompletionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceCompletionRequestDescriptor = $convert
    .base64Decode('ChdTb3VyY2VDb21wbGV0aW9uUmVxdWVzdBIaCghyZXZpc2lvbhgBIAEoBFIIcmV2aXNpb24SHg'
        'oKZ2VuZXJhdGlvbhgCIAEoBFIKZ2VuZXJhdGlvbhISCgRwYXRoGAMgASgJUgRwYXRoEhIKBHRl'
        'eHQYBCABKAlSBHRleHQSFgoGb2Zmc2V0GAUgASgNUgZvZmZzZXQ=');

@$core.Deprecated('Use sourceCompletionResponseDescriptor instead')
const SourceCompletionResponse$json = {
  '1': 'SourceCompletionResponse',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'generation', '3': 2, '4': 1, '5': 4, '10': 'generation'},
    {'1': 'items', '3': 3, '4': 3, '5': 11, '6': '.bdl.v1.DraftCompletionItem', '10': 'items'},
...
/// Descriptor for `SourceCompletionResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceCompletionResponseDescriptor = $convert
    .base64Decode('ChhTb3VyY2VDb21wbGV0aW9uUmVzcG9uc2USGgoIcmV2aXNpb24YASABKARSCHJldmlzaW9uEh'
        '4KCmdlbmVyYXRpb24YAiABKARSCmdlbmVyYXRpb24SMQoFaXRlbXMYAyADKAsyGy5iZGwudjEu'
        'RHJhZnRDb21wbGV0aW9uSXRlbVIFaXRlbXM=');

@$core.Deprecated('Use sourceHoverRequestDescriptor instead')
const SourceHoverRequest$json = {
  '1': 'SourceHoverRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'generation', '3': 2, '4': 1, '5': 4, '10': 'generation'},
    {'1': 'path', '3': 3, '4': 1, '5': 9, '10': 'path'},
...
/// Descriptor for `SourceHoverRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceHoverRequestDescriptor = $convert
    .base64Decode('ChJTb3VyY2VIb3ZlclJlcXVlc3QSGgoIcmV2aXNpb24YASABKARSCHJldmlzaW9uEh4KCmdlbm'
        'VyYXRpb24YAiABKARSCmdlbmVyYXRpb24SEgoEcGF0aBgDIAEoCVIEcGF0aBISCgR0ZXh0GAQg'
        'ASgJUgR0ZXh0EhYKBm9mZnNldBgFIAEoDVIGb2Zmc2V0');

@$core.Deprecated('Use sourceDefinitionRequestDescriptor instead')
const SourceDefinitionRequest$json = {
  '1': 'SourceDefinitionRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'generation', '3': 2, '4': 1, '5': 4, '10': 'generation'},
    {'1': 'path', '3': 3, '4': 1, '5': 9, '10': 'path'},
...
/// Descriptor for `SourceDefinitionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceDefinitionRequestDescriptor = $convert
    .base64Decode('ChdTb3VyY2VEZWZpbml0aW9uUmVxdWVzdBIaCghyZXZpc2lvbhgBIAEoBFIIcmV2aXNpb24SHg'
        'oKZ2VuZXJhdGlvbhgCIAEoBFIKZ2VuZXJhdGlvbhISCgRwYXRoGAMgASgJUgRwYXRoEhIKBHRl'
        'eHQYBCABKAlSBHRleHQSFgoGb2Zmc2V0GAUgASgNUgZvZmZzZXQ=');

@$core.Deprecated('Use sourceReferencesRequestDescriptor instead')
const SourceReferencesRequest$json = {
  '1': 'SourceReferencesRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'generation', '3': 2, '4': 1, '5': 4, '10': 'generation'},
    {'1': 'path', '3': 3, '4': 1, '5': 9, '10': 'path'},
    {'1': 'text', '3': 4, '4': 1, '5': 9, '10': 'text'},
    {'1': 'offset', '3': 5, '4': 1, '5': 13, '10': 'offset'},
    {'1': 'include_declaration', '3': 6, '4': 1, '5': 8, '10': 'includeDeclaration'},
  ],
};

/// Descriptor for `SourceReferencesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceReferencesRequestDescriptor = $convert
    .base64Decode('ChdTb3VyY2VSZWZlcmVuY2VzUmVxdWVzdBIaCghyZXZpc2lvbhgBIAEoBFIIcmV2aXNpb24SHg'
        'oKZ2VuZXJhdGlvbhgCIAEoBFIKZ2VuZXJhdGlvbhISCgRwYXRoGAMgASgJUgRwYXRoEhIKBHRl'
        'eHQYBCABKAlSBHRleHQSFgoGb2Zmc2V0GAUgASgNUgZvZmZzZXQSLwoTaW5jbHVkZV9kZWNsYX'
        'JhdGlvbhgGIAEoCFISaW5jbHVkZURlY2xhcmF0aW9u');
...
const SourceLocation$json = {
  ...
  '2': [
    ...
    {'1': 'end', '3': 3, '4': 1, '5': 13, '10': 'end'},
  ],
};

/// Descriptor for `SourceLocation`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceLocationDescriptor = $convert
    .base64Decode('Cg5Tb3VyY2VMb2NhdGlvbhISCgRwYXRoGAEgASgJUgRwYXRoEhQKBXN0YXJ0GAIgASgNUgVzdG'
        'FydBIQCgNlbmQYAyABKA1SA2VuZA==');

@$core.Deprecated('Use sourceLocationsResponseDescriptor instead')
const SourceLocationsResponse$json = {
  '1': 'SourceLocationsResponse',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'generation', '3': 2, '4': 1, '5': 4, '10': 'generation'},
    {'1': 'title', '3': 3, '4': 1, '5': 9, '10': 'title'},
    {'1': 'locations', '3': 4, '4': 3, '5': 11, '6': '.bdl.v1.SourceLocation', '10': 'locations'},
  ],
};

/// Descriptor for `SourceLocationsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceLocationsResponseDescriptor = $convert
    .base64Decode('ChdTb3VyY2VMb2NhdGlvbnNSZXNwb25zZRIaCghyZXZpc2lvbhgBIAEoBFIIcmV2aXNpb24SHg'
        'oKZ2VuZXJhdGlvbhgCIAEoBFIKZ2VuZXJhdGlvbhIUCgV0aXRsZRgDIAEoCVIFdGl0bGUSNAoJ'
        'bG9jYXRpb25zGAQgAygLMhYuYmRsLnYxLlNvdXJjZUxvY2F0aW9uUglsb2NhdGlvbnM=');

@$core.Deprecated('Use formatSourceRequestDescriptor instead')
const FormatSourceRequest$json = {
  '1': 'FormatSourceRequest',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'generation', '3': 2, '4': 1, '5': 4, '10': 'generation'},
    {'1': 'path', '3': 3, '4': 1, '5': 9, '10': 'path'},
...
/// Descriptor for `FormatSourceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List formatSourceRequestDescriptor = $convert
    .base64Decode('ChNGb3JtYXRTb3VyY2VSZXF1ZXN0EhoKCHJldmlzaW9uGAEgASgEUghyZXZpc2lvbhIeCgpnZW'
        '5lcmF0aW9uGAIgASgEUgpnZW5lcmF0aW9uEhIKBHBhdGgYAyABKAlSBHBhdGgSEgoEdGV4dBgE'
        'IAEoCVIEdGV4dA==');

@$core.Deprecated('Use formatSourceResponseDescriptor instead')
const FormatSourceResponse$json = {
  '1': 'FormatSourceResponse',
  '2': [
    {'1': 'revision', '3': 1, '4': 1, '5': 4, '10': 'revision'},
    {'1': 'generation', '3': 2, '4': 1, '5': 4, '10': 'generation'},
    {'1': 'formatted', '3': 3, '4': 1, '5': 8, '10': 'formatted'},
    {'1': 'text', '3': 4, '4': 1, '5': 9, '10': 'text'},
  ],
};

/// Descriptor for `FormatSourceResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List formatSourceResponseDescriptor = $convert
    .base64Decode('ChRGb3JtYXRTb3VyY2VSZXNwb25zZRIaCghyZXZpc2lvbhgBIAEoBFIIcmV2aXNpb24SHgoKZ2'
        'VuZXJhdGlvbhgCIAEoBFIKZ2VuZXJhdGlvbhIcCglmb3JtYXR0ZWQYAyABKAhSCWZvcm1hdHRl'
        'ZBISCgR0ZXh0GAQgASgJUgR0ZXh0');
