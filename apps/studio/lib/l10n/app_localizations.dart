...
abstract class AppLocalizations {
  ...
  /// Tooltip and accessibility label of the menu icon on a selected, hovered edge.
  ///
  /// In en, this message translates to:
  /// **'Connection menu'**
  String get connectionMenu;

  /// Tooltip and accessibility label of the menu icon on a selected, hovered node.
  ///
  /// In en, this message translates to:
  /// **'Node menu'**
  String get nodeMenu;

  /// Tooltip and accessibility label of the menu icon on a selected, hovered behavior group.
  ///
  /// In en, this message translates to:
  /// **'Group menu'**
  String get groupMenu;

  /// Canvas context menu: lay every node out again (layout only).
  ///
  /// In en, this message translates to:
  /// **'Arrange Automatically'**
  String get arrangeAutomatically;

  /// Canvas context menu: put the layout back as it was before the arrangement.
  ///
  /// In en, this message translates to:
  /// **'Undo Arrange'**
  ...
  /// Inspector: an aggregate edge of a collapsed group.
  ///
  /// In en, this message translates to:
  ...
  /// Inspector button: open the formula sheet for the selected relationship.
  ///
  /// In en, this message translates to:
  /// **'Edit…'**
  String get editInSheet;

  /// Tooltip of the Edit… button.
  ///
  /// In en, this message translates to:
  /// **'Open the definition in a sheet with room to work (⌘E)'**
  String get editInSheetTooltip;
  ...
  ///
  /// In en, this message translates to:
  /// **'The definition is read as you type; save when it is right.'**
  String get formulaSheetSubtitle;

  /// Inspector definition section while the formula sheet is open.
  ///
  /// In en, this message translates to:
  /// **'Editing in the sheet.'**
  String get editingInSheet;

  /// Formula sheet: the palette column's title.
  ///
  /// In en, this message translates to:
  /// **'This position'**
  String get thisPosition;

  /// Formula sheet: the palette column with nothing selected.
  ///
  /// In en, this message translates to:
  /// **'Click a part of the formula, or type, to see what the position expects and what fits there.'**
  String get paletteEmptyState;

  /// Formula sheet: the names the formula may read.
  ///
  /// In en, this message translates to:
  /// **'Can read {names}'**
