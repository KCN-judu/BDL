...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get libItem_std_source_temperature_name => '温度输入';

  @override
  String get libItem_std_source_temperature_description => '由环境提供的温度——房间、表面、空气——每次激活读取一次。';

  @override
  String get libItem_std_source_temperature_tags => '温度 输入 传感器 热 测温 热敏电阻';

  @override
  String get libItem_std_source_tilt_name => '倾斜输入';

  @override
  String get libItem_std_source_tilt_description => '产品偏离水平的程度，由环境提供——灯头、手持设备、车身。';

  @override
  String get libItem_std_source_tilt_tags => '倾斜 输入 传感器 倾角 加速度计 水平';

  @override
  String get libItem_std_source_distance_name => '距离输入';

  @override
  String get libItem_std_source_distance_description =>
      '最近的物体离得有多远，由环境提供——障碍物、手、液位。用哪种传感器测量是部署时的选择。';

  @override
  String get libItem_std_source_distance_tags => '距离 输入 传感器 测距 接近 超声波 激光';

  @override
  String get libItem_std_source_ambient_light_name => '环境光输入';

  @override
  String get libItem_std_source_ambient_light_description => '照射到产品上的光量，由环境提供——用于调光、唤醒显示、检测日光。';

  @override
  String get libItem_std_source_ambient_light_tags => '环境光 输入 传感器 照度 光 日光 亮度';

  @override
  String get libItem_std_source_button_name => '按钮输入';

  @override
  String get libItem_std_source_button_description => '此刻按钮是否被按住或开关是否打开，由环境在每次激活时提供——一个稳定状态，而不是事件。';

  @override
  String get libItem_std_source_button_tags => '按钮 输入 开关 状态 按下 按键';

  @override
  String get libItem_std_source_encoder_name => '编码器输入';

  @override
  String get libItem_std_source_encoder_description => '轴或旋钮转到的角度，由环境提供。计脉冲是部署的事。';

  @override
  String get libItem_std_source_encoder_tags => '编码器 输入 位置 旋钮 轴 角度';

  @override
  String get libItem_std_source_analog_name => '模拟输入';

  @override
  String get libItem_std_source_analog_description => '由行为解释的通用模拟读数。值的形式留给你：知道输入测量什么之后，再为概念选择。';

  @override
  String get libItem_std_source_analog_tags => '模拟 输入 ADC 电压 读数 通用';

  @override
  String get libItem_std_source_external_name => '外部输入';

  @override
  String get libItem_std_source_external_description =>
      '由产品外部提供的值——来自主机、网络或仿真——作为行为读取的值。输入并不总是传感器。';

  @override
  String get libItem_std_source_external_tags => '外部 输入 来源 主机 网络 仿真 提供';
}
