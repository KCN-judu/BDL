...
[project-records/STATUS.md](project-records/STATUS.md); what landed and
...
* Studio gaps listed in `docs/STUDIO_COMPILER_INTEGRATION.md` §3 (*What
...
* Supplied Rust computation blocks — designed in
  `docs/COMPONENT_BOUNDARY.md` under ADR-0005; not started.
