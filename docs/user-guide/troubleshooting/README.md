...
| You see                                                                                                                                                                                                                                                                                              | Go to                                                                                                   |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| _declared_, _not yet defined_; _needs a value before simulation can step_; _Checked once … is decided_; _no final target yet_; _Fits … so far — the binding is not finished_                                                                                                                         | [Incomplete design](incomplete-design.md) — none of these is an error                                   |
