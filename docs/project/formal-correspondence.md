...
`docs/spec/kernel.md` transcribes the kernel; `docs/architecture/compiler-pipeline.md`
...
`docs/evidence/behavior-systems-correspondence.md` carries the object-by-object table with every
