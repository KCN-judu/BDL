...
| `docs/background/paper-digest.md`                                               | background (English since 2026-09-19)              | language reader            | no                            | historical context            | —                                                                                     | keep                         | registered as background                                       |
| `docs/spec/kernel.md`                                                           | spec (kernel, from Lean; English since 2026-09-19) | contributor, researcher    | yes                           | current (pre-Phase-9a kernel) | does not yet transcribe Phase 9a lists/buffers                                        | keep                         | spec; gap recorded in ISS-0001 and FORMAL_CORRESPONDENCE       |
