...
Generated code computes in `f64` everywhere, matching the reference
evaluator bit for bit; an embedded target may want `f32`, which the
differential tests cannot hide.
