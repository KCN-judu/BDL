...
| [ISS-0011](0011-buffer-capacity-validation.md)                                     | Capacity validation for collections and the buffer        | open     | deployment       | schedules and a target memory model as deployment data          |
| [ISS-0012](0012-representation-level-comparison-bypasses-the-order-declaration.md) | A concept beside a plain value compares by representation | open     | language         | a decision on the mixed comparison                              |
| [ISS-0013](0013-filter-copies-its-accumulator-in-the-generated-core.md)            | `filter` copies its accumulator in the generated core     | open     | codegen          | a lazy conditional, a shared list, or a peephole                |

## Resolved

| ID  | Issue                                 | Resolved by |
| --- | ------------------------------------- | ----------- |
| —   | _none since the registry was created_ |             |
