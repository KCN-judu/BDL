...
| [ISS-0017](0017-output-realization-open-items.md)                        | Output realization beyond a pure encoder                        | open     | deployment       | an ADR consuming FV Phase 15/17's device clock and window; FV for stateful adapters             |
| [ISS-0018](0018-the-input-half-beyond-one-reading-per-tick.md)           | The input half beyond one line read once per tick               | open     | deployment       | a first identity-carrying provider; FV for stateful transducers (FVI-0020)                      |
| [ISS-0019](0019-a-concepts-display-unit.md)                              | A concept has no display unit                                   | open     | persistence      | where a presentation unit lives (the file, a preference, or inferred); ADR-0033's one rendering |
| [ISS-0020](0020-a-concepts-producers-and-what-an-edge-into-it-may-do.md) | A concept's producers, and what an edge into it may do          | open     | formal           | where a presentation unit lives (the file, a preference, or inferred); ADR-0033's one rendering |
...
| [ISS-0014](0014-unit-domain-normalization-in-the-formal-kernel.md)                 | Prove the Unit-domain normalization of relationships without inputs | ADR-0032 (FV Phase 12)      |
| [ISS-0016](0016-a-device-binding-for-a-source.md)                                  | A device binding for a Source                                       | ADR-0038 (FV Phases 13, 16) |
