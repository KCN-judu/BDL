...
| [ISS-0016](0016-a-device-binding-for-a-source.md)                       | A device binding for a Source                                   | open     | deployment       | the first embedded platform adapter's device catalog, then an ADR extending ADR-0015    |
...
| [ISS-0017](0017-output-realization-open-items.md)                       | Output realization beyond a pure encoder                        | open     | deployment       | the first embedded platform adapter; FV phases for a device clock and stateful adapters |
