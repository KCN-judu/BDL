...
the Deploy read model (docs/architecture/deployment-read-model.md). No Rust source
...
Arduino Nano (table in `docs/spec/kernel.md` §9) — kept as allocation
...
inside — `MappingStatus` (docs/architecture/compiler-pipeline.md).
