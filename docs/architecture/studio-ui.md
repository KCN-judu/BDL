...
docs/architecture/studio-compiler-integration.md). Studio owns the draft — its text,
...
with bdld's reference evaluator (docs/spec/runtime-semantics.md) doing every
