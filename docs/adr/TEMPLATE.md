...
The choice, in the present tense, as a rule the code follows.

## Alternatives

What else was on the table and why it lost. Omit only if there was no
alternative worth recording.

## Consequences

What becomes easier, what becomes harder, what other records change
(specification section, status row, change fragment).
