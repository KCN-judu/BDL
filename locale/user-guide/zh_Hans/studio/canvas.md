...
在空白画布上：**添加概念 ▸**——_最近_、_输入_、_输出_、三个最常用的类别、_更多…_（打开库标签页）；**添加来源 ▸**——_新建来源…_ 与各预设（_温度输入_、_倾斜输入_……），每一项都打开[来源表单](../../../../docs/user-guide/studio/library.md#sources)，在那里选择来源所提供的概念——已有的，或随之新建的；**添加实例 ▸** _组件_ 和**新建行为组**。
