//! Generated by bdl-codegen-rust 0.1.0 for design `lamp_output`. Do not edit.
//!
...
pub const DESIGN: &str = "lamp_output";
...
pub fn step(state: &mut State, active: ActiveDomains, inputs: &Inputs) -> Result<Tick, RuntimeError> {
    ...
    Ok(Tick { values: Values { decl_0: decl_0, decl_2: decl_2 }, outputs: Outputs { output_4: decl_2.clone() }, commands: Commands {} })
}
