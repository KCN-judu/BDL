//! Generated by bdl-codegen-rust 0.1.0 for design `no_domains`. Do not edit.
//!
...
pub const DESIGN: &str = "no_domains";

/// Whether the design has any clock domain; decides when domain-agnostic declarations run (DI-16).
pub const HAS_DOMAINS: bool = false;

pub const CLOCK_COUNT: u16 = 0_u16;
