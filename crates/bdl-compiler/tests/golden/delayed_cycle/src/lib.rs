//! Generated by bdl-codegen-rust 0.1.0 for design `delayed_cycle`. Do not edit.
//!
...
pub const DESIGN: &str = "delayed_cycle";
...
pub fn step(state: &mut State, active: ActiveDomains, inputs: &Inputs) -> Result<Tick, RuntimeError> {
    ...
    Ok(Tick { values: Values { decl_0: decl_0, decl_1: decl_1 }, outputs: Outputs {}, commands: Commands {} })
}
