//! Generated by bdl-codegen-rust 0.1.0 for design `div_by_zero`. Do not edit.
//!
...
pub const DESIGN: &str = "div_by_zero";
...
pub fn step(state: &mut State, active: ActiveDomains, inputs: &Inputs) -> Result<Tick, RuntimeError> {
    ...
    // inv (decl#1)
    let decl_1: Option<f64> = if active.is_active(CLOCK_0) { Some(num::div(1.0_f64, read_decl(&decl_0, 0_u64)?, 1_u64)?) } else { None };
